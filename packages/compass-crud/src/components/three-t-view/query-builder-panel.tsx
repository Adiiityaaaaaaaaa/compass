  ...
  return (
    <div className={panel} data-testid="three-t-query-builder">
      ...
      >
        ...
        <FieldDropZone
          testId="three-t-query-drop-zone"
      ...
      >
        ...
        <FieldDropZone
          testId="three-t-projection-drop-zone"
      ...
      {errors.length > 0 && (
        <ul className={errorList} data-testid="three-t-builder-errors">
          {errors.map((error) => (
            <li key={error}>
              <Body>{error}</Body>
            </li>
